(async()=>{
  await import('./consent-manager.js');
  ...
  if(page==='businesses.html'){
    ...
    if(note)note.innerHTML='<strong>How to read these reviews</strong><p>Scores are provisional and based only on information publicly available on each organization’s own website. These listings are not claimed profiles, verified UNIGO partners, endorsements, or audited impact assessments.</p><div class="method-grid"><span><strong>CRS</strong><br>Carbon Reduction</span><span><strong>GES</strong><br>Gender Equality</span><span><strong>LGBTQIS</strong><br>LGBTQ+ Inclusion</span><span><strong>LES</strong><br>Local Economy</span><span><strong>CIS</strong><br>Community Impact</span></div>';
