...
if(homeJoin&&!document.querySelector('.early-bird-section')){
  ...
  rewards.innerHTML=`<div class="section-heading"><p class="eyebrow">Founding member rewards</p><h2>Join early. Grow with UNIGO.</h2><p>Simple rewards for the people and partners helping build the movement from day one.</p></div><div class="reward-grid"><article><span class="reward-badge">Founding Member</span><h3>250 Impact Credits</h3><p>Get early access, receive a founding badge and get priority access to future partner rewards.</p></article><article><span class="reward-badge">Referral Reward</span><h3>50 + 50 Credits</h3><p>Invite a friend. When they join with your code, both of you receive 50 Impact Credits.</p></article><article><span class="reward-badge">Founding Partner</span><h3>Priority visibility</h3><p>Early businesses receive a founding badge, priority review and featured early-access placement.</p></article></div><p class="reward-note">Impact Credits are early-access rewards. Redemption options will expand as verified partners join.</p>`;
